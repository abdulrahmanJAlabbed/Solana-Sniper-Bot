...
exports.SignatureHandler = void 0;
exports.getMintFromSignature = getMintFromSignature;
const web3_js_1 = require("@solana/web3.js");
const env_validator_1 = require("../env-validator");
const config_1 = require("../../config");
// Constants
const WSOL_MINT = config_1.config.wsol_pc_mint;
/**
...
class SignatureHandler {
    constructor(connection) {
        ...
        this.connection = connection || new web3_js_1.Connection(env.HELIUS_HTTPS_URI, "confirmed");
    }
    /**
     ...
     */
    async getMintFromSignature(signature) {
